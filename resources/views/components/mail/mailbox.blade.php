                   ...
                   <div class="p-4 d-flex flex-column h-100">
                       ...
                       <div class="mx-n4 px-4 email-menu-sidebar-scroll" data-simplebar>
                           <div class="mail-list mt-3">
                               ...
                               <a href="#"><i class="ri-inbox-archive-fill me-3 align-middle fw-medium"></i>
                           ...
                           <div class="border-top border-top-dashed pt-3 mt-3">
                               ...
                               <div class="mt-2 vstack email-chat-list mx-n4">
                                   ...
                                   <a href="javascript: void(0);" class="d-flex align-items-center">
                                       ...
                                       <div class="flex-grow-1 chat-user-box overflow-hidden">
                                           <h5 class="fs-13 text-truncate mb-0 chatlist-user-name">Julian Rosa
                                           </h5>
                                   ...
                                   <a href="javascript: void(0);" class="d-flex align-items-center">
                                       ...
                                       <div class="flex-grow-1 chat-user-box overflow-hidden">
                                           <h5 class="fs-13 text-truncate mb-0 chatlist-user-name">Jay Baker
                                           </h5>
                                           <small class="text-muted text-truncate mb-0">Wow that's
                                               great</small>
                                       </div>
                                   </a>
                               </div>
                                           ...
                                           <div class="col">
                                               <div class="btn-group" role="group">
                                                   ...
                                                   <button type="button"
                                                       class="btn btn-sm py-0 fs-15 btn-light material-shadow-none"
                                                       data-bs-toggle="tooltip" data-bs-placement="top"
                                                       title="Italic"><i class="ri-italic align-bottom"></i></button>
                                                   <button type="button"
                                                       class="btn btn-sm py-0 fs-15 btn-light material-shadow-none"
                                                       data-bs-toggle="tooltip" data-bs-placement="top"
