        ...
        <div class="container-fluid">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="flex-shrink-0">
                                    <img src="{{ $farm->owner_avatar ? asset($farm->owner_avatar) : asset('admin/assets/images/users/user-dummy-img.jpg') }}"
                                        alt="Owner Avatar" class="rounded-circle avatar-lg img-thumbnail"
                    ...
                    <div class="card overflow-hidden">
                        <div class="position-relative">
                            <img src="{{ $farm->thumbnail ? asset('storage/' . $farm->thumbnail) : asset('admin/assets/images/default/farm-placeholder.jpg') }}"
                                alt="{{ $farm->name }}" class="card-img-top" style="height:280px;object-fit:cover;">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-sm flex-shrink-0">
                                                <span
                                                    class="avatar-title rounded-circle bg-soft-success text-success fs-18">
                                ...
                                @if ($farm->email)
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-sm flex-shrink-0">
                                                <span
                                                    class="avatar-title rounded-circle bg-soft-primary text-primary fs-18">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Location on Map</h5>
                        </div>
                    ...
                    @if ($farm->media->isNotEmpty())
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <span class="badge bg-primary-subtle text-primary">{{ $farm->media->count() }}
                                    files</span>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                    @foreach ($farm->media as $media)
                                        <div class="col-lg-3 col-md-4 col-6">
                                            @if ($media->media_type === 'video')
                                                <div class="position-relative rounded overflow-hidden"
                                                    ...
                                                    <div class="position-absolute top-50 start-50 translate-middle">
                                                        <span
                                                            class="avatar-sm bg-white rounded-circle d-flex align-items-center justify-content-center shadow">
                                                            <i class="ri-play-fill text-primary fs-18"></i>
                                                        </span>
                                                    </div>
                                                    @if ($media->duration_seconds)
                                                        <span
                                                            class="position-absolute bottom-0 end-0 m-2 badge bg-dark fs-11">
                                            ...
                                            @if ($media->caption)
                                                <small
                                                    class="text-muted d-block mt-1 text-truncate">{{ $media->caption }}</small>
                                            @endif
                                        </div>
                                    @endforeach
                                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between py-2">
                                ...
                                <span
                                    class="badge bg-{{ $sc[$farm->status] ?? 'secondary' }}-subtle text-{{ $sc[$farm->status] ?? 'secondary' }}">
                                    {{ ucfirst($farm->status) }}
                                </span>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Coordinates</h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-6">
                    ...
                    <div class="card d-none">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="p-3 rounded-1" style="background:{{ $farm->marker_color }};">
                            ...
                            <div class="p-3 rounded-1 bg-light">
                    ...
                    {{-- Tags --}}
                    @if (is_array($farm->tags) && count($farm->tags) > 0)
                        <div class="card">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2">
                                    @foreach ($farm->tags as $tag)
                                        <span
                                            class="badge bg-primary-subtle text-primary fs-12">{{ $tag }}</span>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-grid gap-2">
                            <button type="button"
                                class="btn btn-soft-{{ $farm->status === 'active' ? 'warning' : 'success' }}"
                                id="toggleStatusBtn">
                                <i class="ri-toggle-line me-1"></i>
                                {{ $farm->status === 'active' ? 'Set Inactive' : 'Set Active' }}
                            </button>
                            <button type="button"
                                class="d-none btn btn-soft-{{ $farm->is_featured ? 'secondary' : 'warning' }}"
...
@push('scripts')
    ...
    <script>
        ...
        window.initShowMap = function() {
            const pos = {
                lat: window.__FARM_LAT,
                lng: window.__FARM_LNG
            };
