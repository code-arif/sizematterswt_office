...
@section('title', 'Edit Farm - ' . $farm->name)
...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form id="farmForm" method="POST" novalidate>
                @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="owner_name" name="owner_name"
                                        value="{{ old('owner_name', $farm->owner_name) }}" placeholder="Enter owner name">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="owner_phone" name="owner_phone"
                                        value="{{ old('owner_phone', $farm->owner_phone) }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="owner_address" name="owner_address"
                                        value="{{ old('owner_address', $farm->owner_address) }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex align-items-start gap-3">
                                        ...
                                        <img id="ownerAvatarPreview"
                                            src="{{ $farm->owner_avatar ? asset( $farm->owner_avatar) : asset('admin/assets/images/users/user-dummy-img.jpg') }}"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                            value="{{ old('name', $farm->name) }}" placeholder="Enter farm name">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="description" name="description"
                                            rows="3" maxlength="1000">{{ old('description', $farm->description) }}</textarea>
                                        <div class="d-flex justify-content-between mt-1">
                                            <div class="text-danger small" id="error-description"></div>
                                            <small class="text-muted"><span id="descCount">{{ strlen($farm->description ?? '') }}</span>/1000</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" id="phone" name="phone"
                                            value="{{ old('phone', $farm->phone) }}" placeholder="+1 (555) 000-0000">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email"
                                            value="{{ old('email', $farm->email) }}" placeholder="farm@example.com">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="url" class="form-control" id="website" name="website"
                                            value="{{ old('website', $farm->website) }}" placeholder="https://farmwebsite.com">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="tags" name="tags"
                                            value="{{ old('tags', is_array($farm->tags) ? implode(', ', $farm->tags) : '') }}"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    {{-- Pre-filled hidden lat/lng --}}
                                    <input type="hidden" id="latitude"  name="latitude"  value="{{ old('latitude',  $farm->latitude) }}">
                                    <input type="hidden" id="longitude" name="longitude" value="{{ old('longitude', $farm->longitude) }}">

                                    <div class="col-12">
                                        <label for="address" class="form-label">Address <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="address" name="address"
                                            value="{{ old('address', $farm->address) }}" placeholder="Full street address">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <input type="text" class="form-control" id="zip_code" name="zip_code"
                                            value="{{ old('zip_code', $farm->zip_code) }}">
                                    </div>
                                    <div class="col-lg-2">
                                        <label for="country" class="form-label">Country</label>
                                        <input type="text" class="form-control" id="country" name="country"
                                            value="{{ old('country', $farm->country) }}">
                                    </div>

                                    <div class="col-lg-6">
                                        <label class="form-label">Latitude</label>
                                        <input type="text" class="form-control bg-light" id="latDisplay"
                                            readonly value="{{ $farm->latitude }}">
                                        <div class="text-danger small mt-1" id="error-latitude"></div>
                                    </div>
                                    <div class="col-lg-6">
                                        <label class="form-label">Longitude</label>
                                        <input type="text" class="form-control bg-light" id="lngDisplay"
                                            readonly value="{{ $farm->longitude }}">
                    ...
                    <div class="col-lg-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex flex-column gap-2" id="statusGroup">
                                            ...
                                            <label class="status-card active-card {{ $farm->status === 'active' ? 'selected' : '' }}" for="status_active">
                                                <input type="radio" name="status" id="status_active"
                                                    value="active" @checked($farm->status === 'active') class="d-none">
                                            ...
                                            <label class="status-card inactive-card {{ $farm->status === 'inactive' ? 'selected' : '' }}" for="status_inactive">
                                                <input type="radio" name="status" id="status_inactive"
                                                    value="inactive" @checked($farm->status === 'inactive') class="d-none">
                                                <div class="d-flex align-items-center gap-3">
                                                    <span class="status-icon">
                                            ...
                                            <label class="status-card pending-card {{ $farm->status === 'pending' ? 'selected' : '' }}" for="status_pending">
                                                <input type="radio" name="status" id="status_pending"
                                                    value="pending" @checked($farm->status === 'pending') class="d-none">
                                                <div class="d-flex align-items-center gap-3">
                                                    <span class="status-icon">
                                    ...
                                    <div class="col-12">
                                        <label class="featured-toggle-card {{ $farm->is_featured ? 'on' : '' }}" for="is_featured" id="featuredCard">
                                            <input class="d-none" type="checkbox" id="is_featured"
                                                name="is_featured" value="1" @checked($farm->is_featured)>
                                            <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div class="col-12 mt-2">
                                        <div class="hstack gap-2">
                                            <button type="submit" class="btn btn-primary w-100" id="submitBtn">
                                                <span id="submitBtnText"><i class="ri-save-line me-1"></i> Update Farm</span>
                            ...
                            <div class="card-body">
                                <div class="text-center mb-3">
                                    <img id="thumbnailPreview"
                                        src="{{ $farm->thumbnail ? asset('storage/' . $farm->thumbnail) : asset('admin/default/placeholder.png') }}"
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                <h5 class="card-title mb-0 flex-grow-1">Farm Gallery</h5>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            <input type="color" class="form-control form-control-color"
                                                id="markerColorPicker" value="{{ $farm->marker_color }}"
                                                style="max-width:50px;">
                                            <input type="text" class="form-control" id="marker_color"
                                                name="marker_color" value="{{ $farm->marker_color }}" maxlength="7">
                                        </div>
                                    ...
                                    <div class="col-12 d-none">
                                        ...
                                        <div id="markerPreview" class="d-inline-flex align-items-center gap-2 px-3 py-2 rounded"
                                            style="background:{{ $farm->marker_color }};">
                                            <i class="ri-map-pin-fill text-white fs-18"></i>
                                            <span class="text-white small fw-medium" id="markerPreviewLabel">{{ $farm->marker_icon }}</span>
                                        </div>
                                    </div>
...
window.initFarmMap = function () {
    const existingLat = window.__FARM_LAT;
    const existingLng = window.__FARM_LNG;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.remove-existing-media').forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            Alert.confirm('This file will be deleted permanently.', {
                ...
                const url = "{{ route('admin.farms.media.delete', [$farm->id, ':mediaId']) }}".replace(':mediaId', mediaId);
                axios.delete(url, {
    ...
    picker.addEventListener('input', function () {
        ...
        if (farmMarker) {
            farmMarker.setIcon({
                path: google.maps.SymbolPath.CIRCLE,
                scale: 10, fillColor: this.value, fillOpacity: 1,
    ...
    document.getElementById('farmForm').addEventListener('submit', function (e) {
        ...
        axios.post('{{ route('admin.farms.update', $farm->id) }}', fd, {
