                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="description" name="description"
                                            rows="3" maxlength="1000">{{ old('description', $ranch->description) }}</textarea>
                                        <div class="d-flex justify-content-between mt-1">
                                            <div class="text-danger small" id="error-description"></div>
                                            <small class="text-muted"><span id="descCount">{{ strlen($ranch->description ?? '') }}</span>/1000</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <label for="acreage" class="form-label">Acreage <small class="text-muted">(acres)</small></label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="acreage" name="acreage"
                                                value="{{ old('acreage', $ranch->acreage) }}" min="0" step="0.01">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <input type="hidden" id="latitude"  name="latitude"  value="{{ old('latitude',  $ranch->latitude) }}">
                                    <input type="hidden" id="longitude" name="longitude" value="{{ old('longitude', $ranch->longitude) }}">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" id="city" name="city" value="{{ old('city', $ranch->city) }}">
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="state" class="form-label">State</label>
                                        <input type="text" class="form-control" id="state" name="state" value="{{ old('state', $ranch->state) }}">
                                    </div>
                                    <div class="col-lg-2">
                                        <label for="zip_code" class="form-label">ZIP</label>
                                        <input type="text" class="form-control" id="zip_code" name="zip_code" value="{{ old('zip_code', $ranch->zip_code) }}">
                                    </div>
                                    <div class="col-lg-2">
                                        <label for="country" class="form-label">Country</label>
                                        <input type="text" class="form-control" id="country" name="country" value="{{ old('country', $ranch->country) }}">
                                    </div>

                                    <div class="col-lg-6">
                                        <label class="form-label">Latitude</label>
                                        <input type="text" class="form-control bg-light" id="latDisplay" readonly value="{{ $ranch->latitude }}">
                                        <div class="text-danger small mt-1" id="error-latitude"></div>
                                    </div>
                                    <div class="col-lg-6">
                                        <label class="form-label">Longitude</label>
                                        <input type="text" class="form-control bg-light" id="lngDisplay" readonly value="{{ $ranch->longitude }}">
                    ...
                    <div class="col-lg-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <label class="status-card active-card {{ $ranch->status === 'active' ? 'selected' : '' }}" for="status_active">
                                                <input type="radio" name="status" id="status_active" value="active" @checked($ranch->status === 'active') class="d-none">
                                                <div class="d-flex align-items-center gap-3">
                                                    <span class="status-icon"><i class="ri-checkbox-circle-fill"></i></span>
                                                    <div><p class="mb-0 fw-semibold">Active</p><small>Visible on the map for all users</small></div>
                                                </div>
                                                <i class="ri-check-line check-mark"></i>
                                            </label>

                                            <label class="status-card inactive-card {{ $ranch->status === 'inactive' ? 'selected' : '' }}" for="status_inactive">
                                                <input type="radio" name="status" id="status_inactive" value="inactive" @checked($ranch->status === 'inactive') class="d-none">
                                                <div class="d-flex align-items-center gap-3">
                                                    <span class="status-icon"><i class="ri-forbid-line"></i></span>
                                                    <div><p class="mb-0 fw-semibold">Inactive</p><small>Hidden from map and users</small></div>
                                                </div>
                                                <i class="ri-check-line check-mark"></i>
                                            </label>

                                            <label class="status-card pending-card {{ $ranch->status === 'pending' ? 'selected' : '' }}" for="status_pending">
                                                <input type="radio" name="status" id="status_pending" value="pending" @checked($ranch->status === 'pending') class="d-none">
                                                <div class="d-flex align-items-center gap-3">
                                                    <span class="status-icon"><i class="ri-time-line"></i></span>
                                                    <div><p class="mb-0 fw-semibold">Pending</p><small>Awaiting review before publishing</small></div>
                                                </div>
                                                <i class="ri-check-line check-mark"></i>
                                            </label>
                                    ...
                                    <div class="col-12">
                                        <label class="featured-toggle-card {{ $ranch->is_featured ? 'on' : '' }}" for="is_featured" id="featuredCard">
                                            <input class="d-none" type="checkbox" id="is_featured" name="is_featured" value="1" @checked($ranch->is_featured)>
                                            <div class="d-flex align-items-center gap-3">
                                                <span class="featured-icon"><i class="ri-star-fill"></i></span>
                                                <div><p class="mb-0 fw-semibold">Featured Ranch</p><small>Pinned at the top of the map listings</small></div>
                                            </div>
                                    ...
                                    <div class="col-12 mt-2">
                                        <div class="hstack gap-2">
                                            <button type="submit" class="btn btn-primary w-100" id="submitBtn">
                                                <span id="submitBtnText"><i class="ri-save-line me-1"></i> Update Ranch</span>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="file" class="form-control" id="thumbnail" name="thumbnail" accept="image/jpeg,image/png,image/webp">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            <input type="color" class="form-control form-control-color"
                                                id="markerColorPicker" value="{{ $ranch->marker_color }}" style="max-width:50px;">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div id="markerPreview" class="d-inline-flex align-items-center gap-2 px-3 py-2 rounded"
                                            ...
                                            <span class="text-white small fw-medium" id="markerPreviewLabel">{{ $ranch->marker_icon ?? 'ranch_pin' }}</span>
                                        </div>
                                    </div>
...
<style>
    ...
    .active-card .status-icon { background:#d1f0ea;color:#0ab39c; } .active-card.selected { border-color:#0ab39c;background:#f0fbf9; } .active-card.selected .check-mark { opacity:1;color:#0ab39c; }
    .inactive-card .status-icon { background:#e9ebec;color:#878a99; } .inactive-card.selected { border-color:#878a99;background:#f8f9fa; } .inactive-card.selected .check-mark { opacity:1;color:#878a99; }
    .pending-card .status-icon { background:#fef3d0;color:#f7b84b; } .pending-card.selected { border-color:#f7b84b;background:#fffdf3; } .pending-card.selected .check-mark { opacity:1;color:#f7b84b; }
    .featured-toggle-card { display:flex;align-items:center;justify-content:space-between;padding:12px 14px;border-radius:8px;border:1.5px solid #e9ebec;cursor:pointer;transition:all .2s ease;background:#fff;user-select:none;margin-top:2px; }
    .featured-toggle-card:hover { border-color:#c8cdd5; } .featured-toggle-card.on { border-color:#f7b84b;background:#fffdf3; }
    .featured-icon { width:36px;height:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:17px;background:#fef3d0;color:#f7b84b;flex-shrink:0; }
    .featured-toggle-card small { color:#878a99;font-size:12px; } .featured-toggle-card p { font-size:14px;color:#212529; }
    .featured-switch { width:42px;height:22px;border-radius:20px;background:#d2d6dc;position:relative;transition:background .2s;flex-shrink:0; }
    .switch-knob { position:absolute;top:3px;left:3px;width:16px;height:16px;border-radius:50%;background:#fff;box-shadow:0 1px 3px rgba(0,0,0,.2);transition:left .2s; }
    .featured-toggle-card.on .featured-switch { background:#f7b84b; } .featured-toggle-card.on .switch-knob { left:23px; }
</style>
@endpush
...
window.initRanchMap = function () {
    const center = { lat: window.__RANCH_LAT, lng: window.__RANCH_LNG };
    ...
    ranchMarker = new google.maps.Marker({
        position: center, map: ranchMap, draggable: true, animation: google.maps.Animation.DROP,
        icon: { path: google.maps.SymbolPath.CIRCLE, scale: 10, fillColor: window.__RANCH_MARKER_COLOR, fillOpacity: 1, strokeColor: '#ffffff', strokeWeight: 2 },
    });
    ranchMarker.addListener('dragend', function (e) { reverseGeocode(e.latLng); updateLatLng(e.latLng); });

    autocomplete = new google.maps.places.Autocomplete(document.getElementById('mapSearchInput'), { types: ['geocode', 'establishment'] });
    autocomplete.bindTo('bounds', ranchMap);
    autocomplete.addListener('place_changed', function () {
        const place = autocomplete.getPlace();
        if (!place.geometry?.location) return;
        ranchMap.setCenter(place.geometry.location); ranchMap.setZoom(15);
        placeMarker(place.geometry.location);
        fillAddressFields(place.address_components, place.formatted_address);
    });

    ranchMap.addListener('click', function (event) { placeMarker(event.latLng); reverseGeocode(event.latLng); });
};

function placeMarker(location) { ranchMarker.setPosition(location); updateLatLng(location); }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    picker.addEventListener('input', function () {
        ...
        if (ranchMarker) ranchMarker.setIcon({ path: google.maps.SymbolPath.CIRCLE, scale: 10, fillColor: this.value, fillOpacity: 1, strokeColor: '#ffffff', strokeWeight: 2 });
    });
    colorText.addEventListener('input', function () {
        if (/^#[0-9A-Fa-f]{6}$/.test(this.value)) { picker.value = this.value; preview.style.background = this.value; }
    });
    ...
    document.getElementById('ranchForm').addEventListener('submit', function (e) {
        ...
        axios.post('{{ route('admin.ranches.update', $ranch->id) }}', fd, { headers: { 'Content-Type': 'multipart/form-data' } })
